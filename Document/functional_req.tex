...
%\section{Functional Requirements}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Instructor adds/removes students to/from the assignment}
		Description: Instructor adds or removes student who can view and complete a particular assignment \newline
