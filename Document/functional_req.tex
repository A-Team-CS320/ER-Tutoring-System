...
%\section{Functional Requirements}
    ...
    \begin{section}{Author logs in}
		Description: The Author is logging in, in order to access the Online Tutor System, using his/her NetID and password. \newline
		Primary Actor: Author \newline
		Precondition: The Author is on the login page of the system. \newline
		Trigger: The Author wants to log into the Online Tutor System. \newline
		Successful End Condition: The Author successfully logs into the Online Tutor System. \newline
		Failed End Condition: The Author is unable to log into the Online Tutor System. \newline
        \newline
        Steps:
        \begin{enumerate}
            \item{The Author enters his/her NetID in the username textfield.}
            \item{The Author enters his/her password in the password textfield.}
            \item{The Author clicks on the ‘login’ button to enter the system.}
        \end{enumerate}
        Exceptions:
        \begin{itemize}
            \item{The Author enters an incorrect NetID. In this case a message will be displayed that notifies that the NetID is incorrect.}
			\item{The Author enters an incorrect password. In this case a message will be displayed that notifies that the password is incorrect.}
        \end{itemize}
    \end{section}	
	
	%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author creates new assignment}
		Description: Author creates new assignment for students to be completed \newline
		Primary Actor: Author \newline
		Precondition: Author is logged in into tutoring system \newline
		Trigger: Author clicks on the create an assignment link \newline
        ...
        Steps:
        \begin{enumerate}
            \item{Author clicks on the Create new assignment button on his homepage.}
            \item{Author chooses the class assignment is made for.}
            \item{Author names the assignment}
            \item{Author picks a deadline for the assignment.}
            \item{Author clicks submit button .}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author Removes Assignment}
		The Author will be removing an assignment from the assignment list. \newline
		Primary Actor: Author \newline
		Precondition: There must be at least one assignment in the database. \newline
		Trigger: Author selects to remove an assignment \newline
        ...
        Steps:
        \begin{enumerate}
            \item{Author logs into system.}
            \item{Author selects remove assignment(s).}
            \item{The Author now has a list of assignments from which they can choose from.}
            \item{The Author selects one or more assignments to delete.}
			\item{Select delete assignment(s) and then the select assignments are deleted.}
        \end{enumerate}
        Exceptions:
        \begin{itemize}
            \item{Assignment was already deleted by another Author.}
        \end{itemize}
    \end{section}		
	
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author adds/removes students to the assignment}
		Description: Author adds and removes student who can view and complete a particular assignment \newline
		Primary Actors: Author, Student \newline
		Precondition: Author is logged into the system \newline
		Trigger: Author clicks on “add/remove students” button in the particular assignment \newline
        ...
        Steps:
        \begin{enumerate}
            \item{Author chooses assignment he wants to add/remove students to from the list of already created assignments.}
            \item{Author clicks on “add/remove students” button.}
            \item{Author is given an option to choose an already existing list of students.}
            \item{Author can then choose individual students from student database.}
            \item{Author then can remove any students from the list of students who have been added to the assignment.}
            \item{Author then click on submit button.}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author adds/removes question from the question bank to the assignment}
		Description: Author adds and removes questions for an already created assignment \newline
		Primary Actor: Author \newline
		Precondition:  Author is logged in \newline
		Trigger: Author clicks on ''add/remove question'' button in the particular assignment \newline
        ...
        Steps:
        \begin{enumerate}
            \item{Author chooses assignment he wants to add/remove questions to from the list of already created assignments.}
            \item{Author clicks on “add/remove questions” button.}
            \item{Author can search the bank of questions that has been created by a type/topic of question.}
            \item{Author adds question he likes to the assignment.}
            \item{Author can remove any question he previously chosen from the list of questions.}
            \item{Author then click on submit button.}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author views assignment}
		The Author will be viewing any assignment from the assignment list \newline
		Primary Actor: Author \newline
		Precondition: Author is logged into the system \newline
		Trigger: Author selects to view an assignment \newline
		Successful End Condition: Assignment is retrieved from database and can be viewed by Author \newline
		Failed End Condition: Assignment failed to load \newline
        \newline
        Steps:
        \begin{enumerate}
            \item{Author selects view assignment.}
            \item{Author now has a list of assignments from which they can choose from.}
            \item{Author selects an assignment.}
            \item{Page will appear allowing the Author to view the assignment/questions.}
        \end{enumerate}
        Exceptions:
        \begin{itemize}
            \item{None.}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{section}{Author views Student reports}
		The Author wants to view any student's report for any assignment that the student attempted. \newline
		Primary Actor: Author \newline
		Precondition: Student has attempted the assigned questions \newline
		Trigger: Author attempts to view students stats \newline
        ...
        Steps:
        \begin{enumerate}
            \item{Author selects to view assignments list.}
            \item{Author selects assignments.}
            ...
            \item{Author can select to click on individual student statistics of the assignment.}
        ...
        \end{itemize}
            ...
            \caption{The students repoport that is displayed to the Author}
    \end{figure}
    \end{section}	
    ...
    \begin{section}{User registers for the Online Tutor System}
		Description: An Author or a student registers for the Online Tutor System. \newline
		Primary Actor: Author or student \newline
		Precondition: The Author/student has navigated to the website of the Online Tutor System. \newline
		Trigger: The Author/student clicks the button to register for the Online Tutor System. \newline
		Successful End Condition: The Author/student is successfully registered and provided access to the Online Tutor System. \newline
		Failed End Condition: The Author/student is not successfully registered and does not have access to the Online Tutor System. \newline
		\newline
        Steps:
        \begin{enumerate}
            \item{The Author/student fills in his/her NetID.}
            \item{The Author/student fills in his/her password corresponding with his/her NetID.}
            \item{The NetID and password are the same NetID and password as registered at the University of Massachussetts.}
			\item{The Author/student clicks the ‘register’ button.}
			\item{The Author/student is registered in the Online Tutor System.}
			\item{The Author/student is redirected to his/her homepage (of which the format for Author and student varies).}
        \end{enumerate}
        Exceptions:
        \begin{itemize}
            \item{The Author/student enters an incorrect NetID that is not registered at the University of Massachusetts. In this case a message will be displayed that notifies that the NetID is incorrect.}
			\item{The Author/student enters a password that does not correspond to the NetID that is registered at the University of Massachusetts. In this case a message will be displayed that notifies that the password is incorrect..}
        \end{itemize}
    \end{section}		
